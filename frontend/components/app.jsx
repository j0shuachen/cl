...
const App = () => (
  ...
  <div>
    ...
    <footer>
      ...
      <div className="foot">
        <a className='linkedinlink' href= 'https://www.linkedin.com/in/joshuaschen/'><img className='linkedinlogo' src='https://res.cloudinary.com/dxeyfggji/image/upload/v1507054510/In-White-41px-R_iuuifi.png'/> </a>
