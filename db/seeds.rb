...
gn33 = GroupNews.create!(group_id: group1.id, news: user1.username + ' created the group ' + group1.name, user_id: user1.id, oid: group1.id)
...
gn34 = GroupNews.create!(group_id: group2.id, news: user12.username + ' created the group ' + group2.name, user_id: user12.id, oid: group2.id)
...
gn35 = GroupNews.create!(group_id: group3.id, news: user18.username + ' created the group ' + group3.name, user_id: user18.id, oid: group3.id)
...
gn36 = GroupNews.create!(group_id: group4.id, news: user13.username + ' created the group ' + group4.name, user_id: user13.id, oid: group4.id)
...
gn37 = GroupNews.create!(group_id: group5.id, news: user12.username + ' created the group ' + group5.name, user_id: user12.id, oid: group5.id)
...
gn38 = GroupNews.create!(group_id: group6.id, news: user11.username + ' created the group ' + group6.name, user_id: user11.id, oid: group6.id)
...
gn39 = GroupNews.create!(group_id: group7.id, news: user15.username + ' created the group ' + group7.name, user_id: user26.id, oid: group7.id)
...
gn40 = GroupNews.create!(group_id: group8.id, news: user16.username + ' created the group ' + group8.name, user_id: user16.id, oid: group8.id)
...
gn41 = GroupNews.create!(group_id: group9.id, news: user17.username + ' created the group ' + group9.name, user_id: user17.id, oid: group9.id)
...
gn42 = GroupNews.create!(group_id: group10.id, news: user14.username + ' created the group ' + group10.name, user_id: user14.id, oid: group10.id)
...
gn43 = GroupNews.create!(group_id: group11.id, news: user18.username + ' created the group ' + group11.name, user_id: user18.id, oid: group11.id)
...
gn44 = GroupNews.create!(group_id: group12.id, news: user13.username + ' created the group ' + group12.name, user_id: user13.id, oid: group12.id)
...
gn45 = GroupNews.create!(group_id: group13.id, news: user20.username + ' created the group ' + group13.name, user_id: user20.id, oid: group13.id)
...
gn46 = GroupNews.create!(group_id: group14.id, news: user17.username + ' created the group ' + group14.name, user_id: user17.id, oid: group14.id)
...
gn47 = GroupNews.create!(group_id: group15.id, news: user11.username + ' created the group ' + group15.name, user_id: user11.id, oid: group15.id)
...
gn48 = GroupNews.create!(group_id: group16.id, news: user20.username + ' created the group ' + group16.name, user_id: user26.id, oid: group16.id)
...
gn1 = GroupNews.create!(group_id: group17.id, news: user25.username + ' created the group ' + group17.name, user_id: user25.id, oid: group17.id)
...
gn2 = GroupNews.create!(group_id: group18.id, news: user12.username + ' created the group ' + group18.name, user_id: user12.id, oid: group18.id)
...
gn2 = GroupNews.create!(group_id: group19.id, news: user15.username + ' created the group ' + group19.name, user_id: user19.id, oid: group19.id)
...
gn3 = GroupNews.create!(group_id: group20.id, news: user15.username + ' created the group ' + group20.name, user_id: user15.id, oid: group20.id)
...
gn4 = GroupNews.create!(group_id: group21.id, news: user29.username + ' created the group ' + group21.name, user_id: user29.id, oid: group21.id)
...
gn5 = GroupNews.create!(group_id: group22.id, news: user18.username + ' created the group ' + group22.name, user_id: user18.id, oid: group22.id)
...
gn6 = GroupNews.create!(group_id: group23.id, news: user42.username + ' created the group ' + group23.name, user_id: user42.id, oid: group23.id)
...
gn7 = GroupNews.create!(group_id: group49.id, news: user38.username + ' created the group ' + group49.name, user_id: user38.id, oid: group49.id)
...
gn8 = GroupNews.create!(group_id: group24.id, news: user43.username + ' created the group ' + group24.name, user_id: user43.id, oid: group24.id)
...
gn9 = GroupNews.create!(group_id: group25.id, news: user31.username + ' created the group ' + group25.name, user_id: user31.id, oid: group25.id)
...
gn10 = GroupNews.create!(group_id: group26.id, news: user39.username + ' created the group ' + group26.name, user_id: user39.id, oid: group26.id)
...
gn11 = GroupNews.create!(group_id: group27.id, news: user41.username + ' created the group ' + group27.name, user_id: user41.id, oid: group27.id)
...
gn12 = GroupNews.create!(group_id: group28.id, news: user33.username + ' created the group ' + group28.name, user_id: user33.id, oid: group28.id)
...
gn13 = GroupNews.create!(group_id: group29.id, news: user29.username + ' created the group ' + group29.name, user_id: user29.id, oid: group29.id)
...
gn14 = GroupNews.create!(group_id: group30.id, news: user25.username + ' created the group ' + group30.name, user_id: user25.id, oid: group30.id)
...
gn15 = GroupNews.create!(group_id: group31.id, news: user27.username + ' created the group ' + group31.name, user_id: user27.id, oid: group31.id)
...
gn16 = GroupNews.create!(group_id: group32.id, news: user23.username + ' created the group ' + group32.name, user_id: user23.id, oid: group32.id)
...
gn17 = GroupNews.create!(group_id: group33.id, news: user21.username + ' created the group ' + group33.name, user_id: user21.id, oid: group33.id)
...
gn18 = GroupNews.create!(group_id: group34.id, news: user36.username + ' created the group ' + group34.name, user_id: user36.id, oid: group34.id)
...
gn19 = GroupNews.create!(group_id: group35.id, news: user37.username + ' created the group ' + group35.name, user_id: user37.id, oid: group35.id)
...
gn20 = GroupNews.create!(group_id: group36.id, news: user41.username + ' created the group ' + group36.name, user_id: user41.id, oid: group36.id)
...
gn21 = GroupNews.create!(group_id: group37.id, news: user44.username + ' created the group ' + group37.name, user_id: user44.id, oid: group37.id)
...
gn22 = GroupNews.create!(group_id: group38.id, news: user40.username + ' created the group ' + group38.name, user_id: user40.id, oid: group38.id)
...
gn23 = GroupNews.create!(group_id: group39.id, news: user26.username + ' created the group ' + group39.name, user_id: user26.id, oid: group39.id)
...
gn24 = GroupNews.create!(group_id: group40.id, news: user22.username + ' created the group ' + group40.name, user_id: user22.id, oid: group40.id)
...
gn25 = GroupNews.create!(group_id: group41.id, news: user28.username + ' created the group ' + group41.name, user_id: user28.id, oid: group41.id)
...
gn26 = GroupNews.create!(group_id: group42.id, news: user31.username + ' created the group ' + group42.name, user_id: user31.id, oid: group42.id)
...
gn27= GroupNews.create!(group_id: group43.id, news: user32.username + ' created the group ' + group43.name, user_id: user25.id, oid: group43.id)
...
gn28 = GroupNews.create!(group_id: group44.id, news: user22.username + ' created the group ' + group44.name, user_id: user22.id, oid: group44.id)
...
gn29 = GroupNews.create!(group_id: group45.id, news: user45.username + ' created the group ' + group45.name, user_id: user45.id, oid: group45.id)
...
gn31 = GroupNews.create!(group_id: group47.id, news: user25.username + ' created the group ' + group47.name, user_id: user25.id, oid: group47.id)
...
gn32 = GroupNews.create!(group_id: group48.id, news: user34.username + ' created the group ' + group48.name, user_id: user34.id, oid: group48.id)
